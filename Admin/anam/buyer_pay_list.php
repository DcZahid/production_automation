...
if (isset($_POST["submit"])) {
    ...
    if (!empty($search)) {
        ...
        $search_error = "Please Select A Buyer PHP";
    }
}
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2 offset-8 text-right">
                                <a href="<?php echo $_SESSION['base_url'] ?>/anam/buyer_pay_add.php"
                                    class="btn btn-warning">Add Buyers Payment</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            <form action="" method="post" onsubmit="return d_validation()" id="frm_valid">
                                <div class="row d-flex">
                                    ...
                                    <div class="col-md-6 offset-md-2 d-flex">
                                        <div class=" form-group d-flex ml-auto">
                                            ...
                                            <div>
                                                <input type="date" name="s_date" class="form-control" id="s_date"><span
                                                    id="s_date_error" class="text-danger">
                                                    <?php if (isset($_POST['d_submit'])) {
                                                        echo $s_date_error;
                                                    } ?>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <div>
                                                <input type="date" name="e_date" class="form-control" id="e_date"><span
                                                    id="e_date_error" class="text-danger">
                                                    <?php if (isset($_POST['d_submit'])) {
                                                        echo $e_date_error;
                                                    } ?>
                                                </span>
                                        ...
                                        <div>
                                            <input type="submit" name="d_submit" value="Search"
                    ...
                    <tbody>
                        <?php foreach ($buyer as $i => $p) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="buyer_pay_edit.php?id=<?php echo $p['buyer_payment_id'] ?>"
                                        class="btn btn-success btn-sm">Edit</a>
                                    <a href="buyer_pay_delete.php?id=<?php echo $p['buyer_payment_id'] ?>"
