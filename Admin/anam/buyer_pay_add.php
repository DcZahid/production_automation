                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="amount" class="form-control" id="amount"
                                            placeholder="Enter Buyer Amount"><span id="amount_error"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="method" class="form-control" id="method"
                                            placeholder="Enter Payment Method"><span id="method_error"></span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date" class="form-control" id="date"
                                            placeholder="Enter Payment Date"><span id="date_error"></span>
                                    </div>
                                </div>
                            </div>
