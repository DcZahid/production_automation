                            ...
                            <tbody>
                                <?php foreach ($order as $i => $o) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="orders_edit.php?id=<?php echo $o['id'] ?>" class="btn btn-success btn-sm">Update</a>

                                            <a href="orders_delete.php?id=<?php echo $o['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('are you sure to delete')">Delete</a>

                                            <a href="order_overview.php?id=<?php echo $o['id'] ?>" class="btn btn-warning btn-sm">Report</a>
                                        </td>
                                    </tr>
                                <?php } ?>
